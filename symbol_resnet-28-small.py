...
def conv_factory(data, num_filter, kernel, stride, pad, act_type = 'relu', conv_type = 0):
	...
	#act = mx.symbol.Activation(data = conv, act_type=act_type)#chagned!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def residual_factory(data, num_filter, dim_match):
	...
	##new_data = conv2#chagned!!!!!!!!!!!!!!!!!!!!!!!!!!!
        #act = mx.symbol.Activation(data=new_data, act_type='relu')
        #return act

	#relu before add
	act = mx.symbol.Activation(data=conv2, act_type='relu')
	new_data = identity_data + act
	return new_data
    else:        
...
def get_symbol(num_classes = 1000):#changed!!!!!!!!!1
    ...
    label = mx.symbol.Variable("softmax_label")#changed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    #label = mx.symbol.Variable("softmax_label")
    #label = mx.symbol.Variable("LinearRegression_label")#changed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    LinearRegression = mx.symbol.LinearRegressionOutput(data=fc, label=label, name='LinearRegression')#changed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
